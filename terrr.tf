...
provider "aws" {
  region     = "us-west-1"
  #for security reasons i have removed the the secret key and access key
}
...
#Attaching the volume to our webserver
...
resource "aws_cloudfront_distribution" "cloufront" {
  origin {
...
#route53 coming soon to a theatre near you